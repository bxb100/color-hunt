        ...
        >
            <Form.TagPicker title="Colors" {...itemProps.colors}>
                <Form.TagPicker.Item
                    value="blue"
                    title="Blue"
                    icon={{ source: Icon.CircleFilled, tintColor: "#3da5ff" }}
                />
                <Form.TagPicker.Item
                    value="teal"
                    title="Teal"
                    icon={{ source: Icon.CircleFilled, tintColor: "#00b9a8" }}
                />
                <Form.TagPicker.Item
                    value="mint"
                    title="Mint"
                    icon={{ source: Icon.CircleFilled, tintColor: "#83f3b8" }}
                />
                <Form.TagPicker.Item
                    value="green"
                    title="Green"
                    icon={{ source: Icon.CircleFilled, tintColor: "#74dc2e" }}
                />
                <Form.TagPicker.Item
                    value="sage"
                    title="Sage"
                    icon={{ source: Icon.CircleFilled, tintColor: "#afbf8d" }}
                />
                <Form.TagPicker.Item
                    value="yellow"
                    title="Yellow"
                    icon={{ source: Icon.CircleFilled, tintColor: "#ffe272" }}
                />
                <Form.TagPicker.Item
                    value="beige"
                    title="Beige"
                    icon={{ source: Icon.CircleFilled, tintColor: "#f1d299" }}
                />
                <Form.TagPicker.Item
                    value="brown"
                    title="Brown"
                    icon={{ source: Icon.CircleFilled, tintColor: "#986a33" }}
                />
                <Form.TagPicker.Item
                    value="orange"
                    title="Orange"
                    icon={{ source: Icon.CircleFilled, tintColor: "#ff9351" }}
                />
                <Form.TagPicker.Item
                    value="peach"
                    title="Peach"
                    icon={{ source: Icon.CircleFilled, tintColor: "#eba39c" }}
                />
                <Form.TagPicker.Item
                    value="red"
                    title="Red"
                    icon={{ source: Icon.CircleFilled, tintColor: "#ff3737" }}
                />
                <Form.TagPicker.Item
                    value="maroon"
                    title="Maroon"
                    icon={{ source: Icon.CircleFilled, tintColor: "#a72626" }}
                />
                <Form.TagPicker.Item
                    value="pink"
                    title="Pink"
                    icon={{ source: Icon.CircleFilled, tintColor: "#ff74bc" }}
                />
                <Form.TagPicker.Item
                    value="purple"
                    title="Purple"
                    icon={{ source: Icon.CircleFilled, tintColor: "#bf51e0" }}
                />
                <Form.TagPicker.Item
                    value="navy"
                    title="Navy"
                    icon={{ source: Icon.CircleFilled, tintColor: "#414796" }}
                />
                <Form.TagPicker.Item
                    value="black"
                    title="Black"
                    icon={{ source: Icon.CircleFilled, tintColor: "#333" }}
                />
                <Form.TagPicker.Item
                    value="grey"
                    title="Grey"
